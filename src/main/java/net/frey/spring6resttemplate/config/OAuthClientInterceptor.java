...
public class OAuthClientInterceptor implements ClientHttpRequestInterceptor {
    ...
    private final Authentication principle;
    private final ClientRegistration clientRegistration;

    public OAuthClientInterceptor(
            OAuth2AuthorizedClientManager manager, ClientRegistrationRepository registrationRepository) {
        this.manager = manager;
        this.principle = createPrinciple();
        this.clientRegistration = registrationRepository.findByRegistrationId("springauth");
    }
    ...
    private Authentication createPrinciple() {
